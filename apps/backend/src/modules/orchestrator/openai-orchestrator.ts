...
const COST_ESTIMATES: Record<AllowedBlockType, number> = {
    ...
    'media-video': 0.2,
    integration: 0.01,
    // source/brief/storyboard run on openaiWritingModel (mini); script/motion stay on nano.
    'longform-source': 0.05,
    'longform-brief': 0.06,
    'longform-script': 0.04,
    'longform-storyboard': 0.08,
    ...
    // blog brief/outline/draft run on the larger writing model (openaiWritingModel); draft is
    // section-by-section so it dominates. blog-research multiplies on comparison topics (per-target search).
    'blog-brief': 0.04,
    'blog-research': 0.03,
    'blog-outline': 0.04,
    'blog-draft': 0.3,
