/**
 * Shorts-pack orchestrator prompt.
 * Moved from modules/orchestrator/prompt-templates.ts (shorts-specific portion).
 */

export const SHORTS_PROMPT_VERSION = 'v1.0.0';

export const SHORTS_ORCHESTRATOR_SYSTEM_PROMPT = `You are an AI workflow designer for an education shorts video platform.
...
export const buildShortsUserPrompt = (userMessage: string, flowContext?: string): string => {
