        ...
        useImperativeHandle(
            ...
            () => ({
                ...
                loadWorkflow: async (state: WorkflowStateWithPorts) => {
                    ...
                    // Display nodes immediately. Suppress onChange: loading server data must not
                    // echo back as a local save (prevents load->save->WS->load loop).
                    ...
                    if (canvasEl && nodesReadyToRender.length > 0) {
