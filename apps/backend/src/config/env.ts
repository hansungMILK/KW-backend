...
export const env = {
    ...
    localQueueMode: readEnv('LOCAL_QUEUE_MODE', 'worker'),
    ...
    openaiContentMaxTokens: readIntEnv('OPENAI_CONTENT_MAX_TOKENS', 4096, 1),
    openaiCountryballContentMaxTokens: readIntEnv('OPENAI_COUNTRYBALL_CONTENT_MAX_TOKENS', 8192, 1),
    openaiLongformGateAMaxTokens: readIntEnv('OPENAI_LONGFORM_GATE_A_MAX_TOKENS', 8192, 1),
    openaiContentRetryMaxTokens: readIntEnv('OPENAI_CONTENT_RETRY_MAX_TOKENS', 12288, 1),
    ...
    elevenLabsTtsMaxAttempts: readIntEnv('ELEVENLABS_TTS_MAX_ATTEMPTS', 1, 1),
    nodeExecutionTimeoutMs: readIntEnv('NODE_EXECUTION_TIMEOUT_MS', 180000, 1),
